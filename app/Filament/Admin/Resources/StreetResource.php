...
use App\Filament\Admin\Resources\StreetResource\Pages;
...
class StreetResource extends Resource
{
    ...
    protected static ?string $navigationIcon = 'phosphor-road-horizon';
    protected static ?string $navigationLabel = 'Ruas';
    protected static ?int $navigationSort = 5;
    protected static ?string $navigationGroup = 'Estrutura';
    protected static ?string $pluralLabel = 'Ruas';
    protected static ?string $modelLabel = 'Rua';

    public static function canAccess(): bool
    {
        return auth()->check() && auth()->user()->can('Gerenciar Ruas');
    }
        ...
        return $table
            ...
            ->filters([
                SelectFilter::make('name')
                    ->label('Nome')
                    ->searchable()
                    ->options(Street::pluck('name', 'name')->toArray()),
